...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.9_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_mxo2 -lang verilog -synth lse -arch xo2c00 -type pll -fin 12 -fclkop 240 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
/* Mon Jul 03 15:06:13 2017 */


`timescale 1 ns / 1 ps
module pll_mxo2 (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
